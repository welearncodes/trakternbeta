...
<form id="redi-reservation" name="redi-reservation" method="post" action="?jquery_fail=true">
			...
			<?php if(isset($$field_name) && !empty($$field_name)):?>
				<div>
					...
					<label for="field_<?php echo $i; ?>"><?php echo $$field_name; ?>:
						<?php if(isset($$field_required) && $$field_required):?><span class="redi_required"> *</span>
	...
	<div id="step4" style="display: none;" class="redi-reservation-alert-success redi-reservation-alert">
        ...
        <br/><br/>
        <?php _e('Your reservation number for reference:') ?> <span id="reservation-id" style="font-weight: bold">100 222</span>
    </div>
</form>
<?php if($thanks):?>
	<div id="Thanks" style="">
